...
## TODO
- Optimize the token bucket algorithm for cross-site IP collision
- Merge the different rate-limiting algos and create an API for users of the library to choose which to use.
